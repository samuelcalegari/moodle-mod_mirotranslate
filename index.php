...
/**
 * List of mirotranslate(s) in course
 *
...
$event = \mod_mirotranslate\event\course_module_instance_list_viewed::create($params);
...
foreach ($mirotranslates as $mirotranslate) {
    ...
    if ($course->format == 'weeks' or $course->format == 'topics') {
        $table->data[] = array ($mirotranslate->section, $link);
    } else {
